(function (Scratch) {
    ...
    if (!Scratch.extensions.unsandboxed) {
        throw new Error("Tint must be run unsandboxed");
    }
    const vm = Scratch.vm;
    ...
    pro._buildShader = function(drawMode, effectBits) {
        ...
        const numEffects = pro.constructor.EFFECTS.length;
    ...
    Scratch.extensions.register(new Tint());
})(Scratch);
